...
public class FlightService {
    ...
    public FlightService(Clock clock) { this.clock=clock; }
    ...
    private Flight flight(Route route, LocalDate day) {
        ...
        return new Flight(route.id()+"_"+day, route.origem(), route.destino(), departure,
            departure.plusSeconds(route.durationMinutes()*60L), new BigDecimal(route.price()), route.seats());
    }
